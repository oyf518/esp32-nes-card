...
static const uint8 null_page[NES6502_BANKSIZE];   /* 优化:全0只读兜底页,挪进 flash rodata,省 4KB DRAM */
...
*/
int nes6502_execute(int timeslice_cycles)   /* B4 已撤:C3 IRAM/DRAM 共享 SRAM,33KB IRAM 挤掉等量堆,得不偿失 */
{
